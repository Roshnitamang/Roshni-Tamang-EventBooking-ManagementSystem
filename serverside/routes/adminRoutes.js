...
import { getSystemStats, getAllUsers, deleteUser, getAllEventsAdmin, approveEvent, deleteEventAdmin, getPendingOrganizers, approveOrganizer, demoteOrganizer, updateUserRole, getEventBookingsAdmin } from '../controllers/adminController.js';
