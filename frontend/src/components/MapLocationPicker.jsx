...
const MapLocationPicker = ({ onLocationSelect, initialLat, initialLng }) => {
    ...
    if (!apiKey || apiKey === 'YOUR_GOOGLE_MAPS_API_KEY_HERE') {
        return (
            <div className="w-full h-[400px] bg-zinc-100 dark:bg-zinc-800 rounded-lg flex flex-col items-center justify-center text-zinc-500 dark:text-zinc-400 border-2 border-dashed border-zinc-300 dark:border-zinc-700">
                ...
                <p className="text-xs mt-4 text-zinc-400">Click on the map to set event location</p>
            </div>
        );
    }
