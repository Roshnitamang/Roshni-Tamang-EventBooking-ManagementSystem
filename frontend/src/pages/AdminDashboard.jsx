                                    ...
                                    <div className="grid grid-cols-1 gap-8">
                                        {pendingOrganizers.length === 0 ? (
                                            ...
                                            pendingOrganizers.map(org => (
                                                <div key={org._id} className="group bg-white dark:bg-zinc-900 p-8 rounded-[3rem] border border-zinc-200 dark:border-zinc-800 hover:border-emerald-500/30 transition-all duration-500 flex flex-col md:flex-row gap-10 items-center shadow-2xl relative overflow-hidden">
                                                    <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/5 rounded-full blur-3xl -mr-16 -mt-16"></div>
                                                    
                                                    <div className="w-24 h-24 rounded-[2rem] bg-zinc-800 flex items-center justify-center font-black text-3xl text-zinc-500 group-hover:bg-emerald-600 group-hover:text-zinc-900 dark:text-white transition-all shadow-inner">
                                                        {org.name[0]}
                                                    </div>
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center gap-3 mb-2">
                                                            ...
                                                            {org.kycDetails && (
                                                                <div className="px-2 py-0.5 bg-emerald-500/10 text-emerald-500 text-[8px] font-black uppercase rounded border border-emerald-500/20 ml-2">
                                                                    Dossier Submitted
                                                                </div>
                                                            )}
                                                        </div>
                                                        ...
                                                        <div className="flex items-center gap-6">
                                                            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-800/50 rounded-full border border-zinc-700/50">
                                                                ...
                                                                <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">{org.location || 'Location Pending'}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto z-10">
                                                        {org.kycDetails ? (
                                                            <button
                                                                ...
                                                                className="flex-1 md:flex-none px-8 py-4 bg-emerald-600 text-zinc-900 dark:text-white rounded-3xl font-black uppercase tracking-[0.3em] text-[10px] hover:bg-emerald-500 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-3"
                                                            >
                                                            ...
                                                            <div className="flex gap-4">
                                                                <button 
                                                                    ...
                                                                    className="px-8 py-4 bg-emerald-600 text-zinc-900 dark:text-white rounded-3xl font-black uppercase tracking-[0.3em] text-[10px] hover:bg-emerald-500 transition-all active:scale-95"
                                                                >
                                                                    Approve
                                                                </button>
                                                                <button 
                                                                    onClick={() => rejectOrganizer(org._id)}
                                                                    className="px-8 py-4 border border-red-500/30 text-red-500/60 hover:text-red-500 hover:border-red-500 rounded-3xl font-black uppercase tracking-[0.3em] text-[10px] transition-all active:scale-95"
                                                                >
                                                                    Reject
                                                                </button>
                                                            </div>
